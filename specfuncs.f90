...
! 23-04-2025 - Rodrigo Castro - Original code
  ...
  ei_t1 = abs(-0.30266853926582593d0 - ei(0.3d0))
  ei_t2 = abs(1.058563689713169d+20 - ei(50.0d0))
  e1x_t1 = abs(0.55977359477616084d0 - e1x(0.5d0))
  e1x_t2 = abs(0.10001958240663265d0 - e1x(1.5d0))
